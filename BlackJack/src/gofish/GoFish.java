...
public class GoFish extends Game{
    ...
    public void play() {
        ...
        do {
            ...
            //loop until the player has to fish, which then means his turn is over
            do {
            ...
            do {
                ...
                switch (computerChoiceNumber) {
                    case 0:
                        computerChoice = GoFishCard.value.valueOf("TWO"); break;
                    case 1:
                        computerChoice = GoFishCard.value.valueOf("THREE"); break;
                    case 2:
                        computerChoice = GoFishCard.value.valueOf("FOUR"); break;
                    case 3:
                        computerChoice = GoFishCard.value.valueOf("FIVE"); break;
                    case 4:
                        computerChoice = GoFishCard.value.valueOf("SIX"); break;
                    case 5:
                        computerChoice = GoFishCard.value.valueOf("SEVEN"); break;
                    case 6:
                        computerChoice = GoFishCard.value.valueOf("EIGHT"); break;
                    case 7:
                        computerChoice = GoFishCard.value.valueOf("NINE"); break;
                    case 8:
                        computerChoice = GoFishCard.value.valueOf("TEN"); break;
                    case 9:
                        computerChoice = GoFishCard.value.valueOf("JACK"); break;
                    case 10:
                        computerChoice = GoFishCard.value.valueOf("QUEEN"); break;
                    case 11:
                        computerChoice = GoFishCard.value.valueOf("KING"); break;
                    case 12:
                        computerChoice = GoFishCard.value.valueOf("ACE"); break;
                }
